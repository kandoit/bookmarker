...
import { ArrowLeft, ExternalLink, Plus, Trash2, FolderOpen, Search, Sparkles, X, Loader2, CheckCircle2, Pencil } from 'lucide-react'
...
export default function WorkspaceDetailPage() {
  ...
  const handleSaveEdit = () => {
    ...
    const wData = updateWorkspace({ version: 1, updatedAt: '', items: workspaces }, workspace.id, {
      name: editName.trim(),
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-2xl z-50 p-6">
            <div className="flex items-center justify-between mb-5">
              <Dialog.Title className="text-lg font-semibold text-slate-900 dark:text-white">Edit Workspace</Dialog.Title>
